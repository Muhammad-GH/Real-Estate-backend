...
$(document).ready(function(){
    ...
    if (winWidth > 1199) {
        ...
        $(".header .navbar .navbar-nav .nav-item .nav-link i").click(function (event) {
            event.preventDefault();
            if (!$(this).hasClass("open")) {
                $(".header .navbar .navbar-nav .nav-item .nav-link i").removeClass("open");
                $(".navbar-sub").slideUp();
                $(this).parent().next(".navbar-sub").slideDown();
                $(this).addClass("open");
            } else {
