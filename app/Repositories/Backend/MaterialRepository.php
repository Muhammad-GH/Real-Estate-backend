...
class MaterialRepository extends BaseRepository
{
     ...
     */
    public function __construct(MaterialPost $model)
    {
        $this->model = $model;
    }
     ...
     * @return mixed
     */
    public function getActivePaginated($paged = 25, $orderBy = 'created_at', $sort = 'desc', $postType='Request') : LengthAwarePaginator
    {
        return $this->model->with('category')
            ->where('post_type',$postType)
            ->whereDate('post_expiry_date', '>=', date('Y-m-d H:i:s'))
