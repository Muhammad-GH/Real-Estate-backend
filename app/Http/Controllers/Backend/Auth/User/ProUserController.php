...
class ProUserController extends Controller
{
     ...
     */
    public function __construct(ProUserRepository $userRepository, UserRepository $usersRepository)
    {
    ...
    {
        return view('backend.auth.prouser.create')
     ...
     * @return mixed
     */
    public function show(ManageUserRequest $request, ProUser $user)
    {
     ...
     * @return mixed
     */
    public function edit(ManageUserRequest $request, RoleRepository $roleRepository, PermissionRepository $permissionRepository, ProUser $user)
    {
