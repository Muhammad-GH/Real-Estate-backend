...
class PropertyController extends Controller
{
    ...
    public function index(Request $request)
    {
        return view('backend.property.index')
            ->withProperties($this->propertyRepository->getActivePaginated(25, 'id', 'desc'));
    }
    ...
    * @param Property              $property
    ...
    public function myymassa_query(Request $request)
    {
        $propertyContact = ContactForm::where('type','myymassa')->orderBy('id', 'desc')->paginate(10);
        return view('backend.property.myymassa')
            ->withPropertyContacts($propertyContact);
    }

    public function myymassa_view(Request $request,$id){
        $propertyContact = ContactForm::where('id', $id)->first();
        ContactForm::where('id',$id)->update(['viewed' => 1]);
        return view('backend.property.myymassaview')
            ->withPropertyContact($propertyContact);
    }


    public function ostamassa_apartments(Request $request)
    {
        $propertyContact = ContactForm::where('type','ostamassa')->orderBy('id', 'desc')->paginate(10);
        return view('backend.property.ostamassa')
            ->withPropertyContacts($propertyContact);
    }

    public function ostamassa_apartment_details(Request $request,$id){
        $propertyContact = ContactForm::where('id', $id)->first();
        ContactForm::where('id',$id)->update(['viewed' => 1]);
        return view('backend.property.ostamassaview')
            ->withPropertyContact($propertyContact);
    }
    ...
    public function ostamassa_apartment_delete (Request $request,$id){
        $propertyContact = ContactForm::where('id', $id)->delete();
        return redirect()->back();
    }
    ...
    public function ostamassa_requests(Request $request){
        $requestData = ContactForm::where('type','ostamassa_contact')->orderBy('id', 'desc')->paginate(10);
        return view('backend.property.ostamassa_requests')
            ->withRequestData($requestData);
    }

    public function ostamassa_request_view(Request $request,$id){
        
        $requestData = ContactForm::where('id', $id)->first();
        ContactForm::where('id',$id)->update(['viewed' => 1]);
        
        $propertyContact = ContactForm::where('id', $requestData->property_type)->first();
        
        // $requestData = ContactForm::where('type','ostamassa_contact')->orderBy('id', 'desc')->paginate(10);
        return view('backend.property.ostamassarequestview')
            ->withPropertyContact($propertyContact)
            ->withRequestData($requestData);
    }
