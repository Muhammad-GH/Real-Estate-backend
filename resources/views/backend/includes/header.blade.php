<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{url('/img/frontend/fk-logo.png')}}" width="89" height="25" alt="Flipkoti">
        <img class="navbar-brand-minimized" src="{{url('/img/frontend/fk-logo-small.png')}}" width="30" height="30" alt="Flipkoti">
    </a>
