                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                       ...
                       <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            {{ html()->label('Language')->class('col-md-2 form-control-label')->for('language') }}

                            <div class="col-md-10">
                                <select name="language" class="form-control" required id="">
                                    @foreach($lang as $langdata)
                                        <option value="{{$langdata->lang_code}}">{{$langdata->name}}</option>
                                    @endforeach
                                </select>
                            </div><!--col-->
                        </div><!--form-group-->
