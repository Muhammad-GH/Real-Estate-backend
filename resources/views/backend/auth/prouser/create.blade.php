...
@section('content')
    {{ html()->form('POST', route('admin.auth.prouser.store'))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.users.type'))->class('col-md-2 form-control-label')->for('type') }}
                            <div class="ui form">
                                <div class="inline fields">
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input type="radio" value="contractor" name="type">
                                        <label>Contractor</label>
                                    </div>
                                    </div>
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input value="supplier" type="radio" name="type">
                        ...
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.access.users.subType'))->class('col-md-2 form-control-label')->for('subType') }}
                            <div class="ui form">
                                <div class="inline fields">
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input type="radio" value="service" name="subtype">
                                        <label>Service Provider (work, material, tools)</label>
                                    </div>
                                    </div>
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input value="material" type="radio" name="subtype">
                                        <label>Material supplier (show only material functionality)</label>
                                    </div>
                                    </div> 
                                </div>
                                <div class="inline fields">
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input type="radio" value="owner" name="subtype">
                                        <label>Property owner/manager (same view as with Sp)</label>
                                    </div>
                                    </div>
                                    <div class="field">
                                    <div class="ui radio checkbox">
                                        <input value="consumer" type="radio" name="subtype">
                                        <label>Consumer( show only sell, buy apartment)</label>
                                    </div>
                                    </div> 
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                @if($roles->count())
                                                <?php unset($roles[0],$roles[1],$roles[2],$roles[5]);?>
                                            ...
                                            <select name="rights[]" multiple="" style="display:none" id="multi_rights" class="ui fluid dropdown">
                                                <option>property</option>
                                                <option>invest property</option>
                                                <option>request</option>
                                                <option>page management</option>
                                                <option>job management</option>
                                                <option>setting</option>
                                                <option>calculator</option>
                                                <option>frontend management</option>
