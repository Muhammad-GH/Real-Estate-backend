                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            @if($roles->count())
                                            <?php unset($roles[3],$roles[4],$roles[5]);?>
                                            ...
                                            <!-- <div class="card">
                                                        <div class="card-header">
                                                            <div class="checkbox d-flex align-items-center">
                                                                <label class="switch switch-label switch-pill switch-primary mr-2" for="role-2"><input class="switch-input" type="checkbox" name="roles[]" id="role-2" value="user"><span class="switch-slider" data-checked="on" data-unchecked="off"></span></label>
                                                                <label for="role-2">Pro User</label>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                                                                                                                                                                None                                                                                                                                                                                    </div>
