...
@section('content')
    {{ html()->modelForm($investProperty,'PATCH', route('admin.investproperty.update',$investProperty->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('novalidate', true)->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">Edit Invest Property</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                @if( $investProperty->image )
                                @php
                                    $image = url('/images/investProperty/'.$investProperty->id.'/'.$investProperty->image);
                                @endphp
                                <span>
                            ...
                            <div class="col-md-10">
                                @if( count($investProperty->investmentImage) > 0 )
                                    @foreach($investProperty->investmentImage as $propImage)
                                        ...
                                        <span>
                                            <img src="{{ $image }}" style="width:250px" alt="Propert picture">
                                            <a href="{{ route('admin.investproperty.deleteimage', $propImage->id) }}" data-method="get" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.delete')" data-trans-button-cancel="@lang('buttons.general.cancel')" data-trans-button-confirm="@lang('buttons.general.crud.delete')" data-trans-title="@lang('strings.backend.general.are_you_sure')" class="btn btn-danger">
