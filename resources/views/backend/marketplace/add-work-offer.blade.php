...
@section('title', app_name() . ' | ' . 'Create Work Offer')
...
@section('content')
{{ html()->form('POST', route('admin.marketplace.addworkoffer'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('novalidate', true)->open() }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">Create work offer</small>
