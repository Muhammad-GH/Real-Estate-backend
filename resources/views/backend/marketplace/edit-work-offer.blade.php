...
@section('title', app_name() . ' | ' . 'Edit Work Offer')
...
@section('content')
{{ html()->modelForm($workData,'POST', route('admin.marketplace.editworkoffer',$workData->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('novalidate', true)->open() }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">Edit work offer</small>
            ...
            <div class="card-footer clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        {{ form_cancel(route('admin.marketplace.index'), __('buttons.general.cancel')) }}
