...
@section('content')
    {{ html()->form('POST', route('admin.pages.update',$pagesId))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('novalidate', true)->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    @foreach($languages as $language)
                        <?php
                            ...
                            $banner =  $banner_title = $content = $name = '';
                            if(isset($data[$language->id])){
                                $name = $data[$language->id]['name'];
                                $content = $data[$language->id]['content'];
                                $banner = $data[$language->id]['banner'];
                                $banner_title = $data[$language->id]['banner_title'];
                            }
                            ?>
