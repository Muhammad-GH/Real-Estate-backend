...
@section('content')
    {{ html()->modelForm($property,'PATCH', route('admin.property.update',$property->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('novalidate', true)->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            {{ html()->label('Debt Free Price')->class('col-md-2 form-control-label')->for('debt_free_price') }}

                            <div class="col-md-10">
                                {{ html()->text('debt_free_price')
                                    ->class('form-control')
                                    ->placeholder('Debt Free Price')
                                    ->required() }}
                            </div><!--col-->
                        </div><!--form-group-->
                            ...
                            <div class="col-md-10">
                                 @if(isset($property->primaryImage->name) &&!empty($property->primaryImage->name))
                                    ...
                                    <span>
                                        ...
                                        <!-- <a href="javascript:void(0);" class="btn btn-danger removeItem" data-id="{{ $property->primaryImage->id }}">
                            ...
                            <div class="col-md-10">
                                @if( count($property->propertyImage) > 0 )
                                    @foreach($property->propertyImage as $propImage)
                                        ...
                                        <span>
                                            <img src="{{ $image }}" style="width:250px" alt="Propert picture">
                                            <a href="{{ route('admin.property.deleteimage', $propImage->id) }}" data-method="get" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.delete')" data-trans-button-cancel="@lang('buttons.general.cancel')" data-trans-button-confirm="@lang('buttons.general.crud.delete')" data-trans-title="@lang('strings.backend.general.are_you_sure')" class="btn btn-danger">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </span>
                                    @endforeach
