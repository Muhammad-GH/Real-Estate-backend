                ...
                <div class="row">
                    ...
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.tender.management') 
                            <small class="text-muted">@lang('labels.backend.tender.create_material_offer') </small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row increment-deliverytype">
                            ...
                            <div class="col-md-4">
                             ...
                             {{ html()->label('Delivery cost')->class('col-md-2 form-control-label')->for('tender_delivery_type_cost') }}
                            <div class="col-md-2">
                                {{ html()->text('tender_delivery_type_cost[]')
                                    ->class('form-control')
                                    ->placeholder('1000')
                                    ->required() }}
                            </div><!--col-->
