...
<page>
    ...
    <table style="padding:0px 10px 10px; width: 100%;">
        ...
        <tr>
            <th>
                <h2 class="heading">Payment millestones</h2>
            </th>
        </tr>
        <tr>
            <td>
                <table>
                    <tr>
                        <td style="width:66.33%; padding-right:10px;">
                            <h4 class="tb-head">Total Cost</h4>
                            <table class="tableed" style="width:100%">
                                <tbody style="width:100%">
                                    @foreach (json_decode($variables["agreement_milestones"], true) as $key => $milestones)
                                    <tr class=<?= $retVal = ($loop->odd) ? 'tb-bg' : ''; ?>>
                                        <td style="width:5%; border-right:none;">{{$key}}</td>
                                        <td style="width:45%; border-right:none;">{{$milestones["des"]}}</td>
                                        <td style="width:25%; text-align:right;border-right:none;">{{$milestones["due_date"]}}</td>
                                        <td style="width:25%; font-weight:bold; text-align:right;">{{$variables["left"]}} {{$milestones["amount"]}} {{$variables["right"]}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <td style="width:33.33%; padding-left:10px;">
                            ...
                            <div class="tableeds" style="height:13px;">
                                <p>{{$variables["agreement_transport_payment"]}}</p>
                            </div>
                            <h4 class="tb-head">Panelty Terms</h4>
                            <div class="">
                                <p style="font-size:10px;">{{$variables["agreement_panelty"]}}</p>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <!--tr>
            <th><h2 class="time" style="padding-bottom:10px;">Project start date: <span>26-08-2020</span></h2></th>
        </tr>
		<tr style="margin-top:0px;">
            <th><h2 class="time">Project start date: <span>26-08-2020</span></h2></th>
        </tr-->
                ...
                <table>
                    <tr style="vertical-align:top;">
                        ...
                        <td style="width:33.33%; padding-left:5px;">
                            ...
                            @endforeach
                            <!-- <div class="boxx">
                                <img src="./res/checked.png" alt="Logo Html2Pdf">Timber agreement
                            </div>
                            <div class="boxx">
                                <img src="./res/checked.png" alt="Logo Html2Pdf">Plumber agreement
                            </div>
                            <div class="boxx">
                                <img src="./res/checked.png" alt="Logo Html2Pdf">Electricity agreement
                            </div> -->
                        </td>
                    </tr>
                </table>
