...
use App\Http\Controllers\Frontend\Auth\ProLoginController;
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        // Route::get('prologout', [ProLoginController::class, 'logout'])->name('logout');
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        // Authentication Routes Pro
        Route::get('prologin', [LoginController::class, 'showProLoginForm'])->name('prologin');
        Route::post('prologin', [ProLoginController::class, 'login'])->name('prologin.post');
        ...
        Route::get('reset-password-form/{token}', [ResetPasswordController::class, 'showResetForm'])->name('reset-password-form');
    });
});
