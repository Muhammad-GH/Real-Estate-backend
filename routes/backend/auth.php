...
use App\Http\Controllers\Backend\Auth\User\ProUserController;
...
use App\Http\Controllers\Backend\Auth\User\ProUserConfirmationController;
...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        //Pro User CRUD
        // Route::get('user', [UserController::class, 'index'])->name('user.index');
        Route::get('prouser/create', [ProUserController::class, 'create'])->name('prouser.create');
        Route::post('prouser', [ProUserController::class, 'store'])->name('prouser.store');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::get('unconfirm', [UserConfirmationController::class, 'unconfirm'])->name('user.unconfirm');
                // Pro Confirmation
                Route::get('proconfirm', [ProUserConfirmationController::class, 'IsConfirmed'])->name('prouser.IsConfirmed');
                Route::get('prounconfirm', [ProUserConfirmationController::class, 'IsUnConfirmed'])->name('prouser.IsUnConfirmed');
